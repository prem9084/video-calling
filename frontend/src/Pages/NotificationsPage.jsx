...
const NotificationsPage = () => {
  ...
  const [acceptedFriendReqs, setAcceptedFriendReqs] = useState([]);
  ...
  const getFriendReqs = async () => {
    ...
    try {
      ...
      if (data.success) {
        setGetFriendReq(data.incommingReq || []);
        setAcceptedFriendReqs(data.accepetedReq || []);
      } else {
          ...
          <>
            ...
            {acceptedFriendReqs.length > 0 && (
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {acceptedFriendReqs.map((notification) => (
                    <div
            ...
            {getFriendReq.length === 0 && acceptRequest.length === 0 && (
